...
from SONALO.misc import db
from SONALI.utils.database import get_loop
from SONALI.utils.decorators import AdminRightsCheck
from SONALI.utils.inline import close_markup, stream_markup, stream_markup2
    ...
    if "live_" in queued:
        ...
        run = await message.reply_photo(
            ...
            caption=_["stream_1"].format(
                f"https://t.me/roshni_x_music_bot?start=info_{videoid}",
                title[:23],
                check[0]["dur"],
                user,
            ),
